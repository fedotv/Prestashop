<?php /* Smarty version Smarty-3.1.19, created on 2015-08-05 14:18:11
         compiled from "/var/www/html/3DPrintShop/themes/default-bootstrap/history.tpl" */ ?>
<?php /*%%SmartyHeaderCode:5951173455c21b23613ec1-19173907%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '872dc33db4a21f579676f95877db680e29109056' => 
    array (
      0 => '/var/www/html/3DPrintShop/themes/default-bootstrap/history.tpl',
      1 => 1436343200,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '5951173455c21b23613ec1-19173907',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_55c21b23858a73_68449921',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_55c21b23858a73_68449921')) {function content_55c21b23858a73_68449921($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_regex_replace')) include '/var/www/html/3DPrintShop/tools/smarty/plugins/modifier.regex_replace.php';
?>
...
<?php $_tmp32=ob_get_clean();?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink('order-opc',true,null,"submitReorder&id_order=".$_tmp32), ENT_QUOTES, 'UTF-8', true);?>
" title="<?php echo smartyTranslate(array('s'=>'Reorder'),$_smarty_tpl);?>
">
							<?php } else { ?>
								<a class="link-button" href="<?php ob_start();?><?php echo intval($_smarty_tpl->tpl_vars['order']->value['id_order']);?>
<?php $_tmp33=ob_get_clean();?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink('order',true,null,"submitReorder&id_order=".$_tmp33), ENT_QUOTES, 'UTF-8', true);?>
" title="<?php echo smartyTranslate(array('s'=>'Reorder'),$_smarty_tpl);?>
">
							<?php }?>
